function Hero() {
  return (
    ...
    <div className="sm:mx-60 mx-10 sm:max-w-[45%] py-32 sm:py-48 lg:py-56 w-70 snap-always">
          <div className="items-start">
            <h1 className="text-xl font-bold tracking-tight text-white-900 sm:text-8xl">
              Let Grow Reach take your business to new heights
            </h1>
            <p className="mt-6 text-sm sm:text-2xl leading-8 text-white-600">
              Ignite your online presence and achieve remarkable growth with our exceptional digital marketing solutions.
            </p>
        ...
        <div
          className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-96"
          aria-hidden="true"
        >
          <div
